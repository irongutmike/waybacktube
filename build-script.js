...
class BuildScript {
    constructor() {
        this.srcDir = __dirname; // Use current directory since modules are in root
    ...
    readModuleFiles() {
        ...
        modules.forEach(moduleName => {
            ...
            if (fs.existsSync(filePath)) {
                ...
                // Don't remove anything - keep the classes intact
    ...
    generateUserscript(moduleContents) {
        ...
        // Add all module contents without modification
        ...
        parts.push(this.generateMainClass());
        parts.push('');
        parts.push('// ===== INITIALIZATION =====');
        parts.push(this.generateInitialization());
        parts.push('');
...
(function() {
    ...
    generateMainClass() {
        return `// Main YouTube Time Machine Class
class YouTubeTimeMachine {
    ...
    generateInitialization() {
        return `// Initialize the Time Machine
let timeMachine;
